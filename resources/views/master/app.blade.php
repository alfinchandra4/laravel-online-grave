...
<body>
  ...
  <main id="main">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-6 about-img wow fadeInLeft">
            <img src="{{asset('theme/img/about-img.jpg')}}" alt="">
          </div>
    ...
    <section id="advanced-features">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="{{asset('theme/img/advanced-feature-1.jpg')}}" alt="">
      ...
      <div class="features-row">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-left" src="{{asset('theme/img/advanced-feature-2.jpg')}}" alt="">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="{{asset('theme/img/advanced-feature-3.jpg')}}" alt="">
              <div class="wow fadeInLeft">
                <h2>Duis aute irure dolor in reprehenderit in voluptate velit esse</h2>
                <h3>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
    ...
    <!--==========================
      Frequently Asked Questions..mb-5 Section
    ============================-->
    <!-- <section id="faq">
      <div class="container">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/gallery-1.jpg" class="gallery-popup">
                <img src="{{asset('theme/img/gallery/gallery-1.jpg')}}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/gallery-2.jpg" class="gallery-popup">
                <img src="{{asset('theme/img/gallery/gallery-2.jpg')}}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/gallery-3.jpg" class="gallery-popup">
                <img src="{{asset('theme/img/gallery/gallery-3.jpg')}}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/gallery-4.jpg" class="gallery-popup">
                <img src="{{asset('theme/img/gallery/gallery-4.jpg')}}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/gallery-5.jpg" class="gallery-popup">
                <img src="{{asset('theme/img/gallery/gallery-5.jpg')}}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/gallery-6.jpg" class="gallery-popup">
                <img src="{{asset('theme/img/gallery/gallery-6.jpg')}}" alt="">
              </a>
            </div>
          </div>
